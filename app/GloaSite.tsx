...
import { GLOA_LAUNCH_FULL_LABEL, launchCountdown, padCountdownUnit } from "../lib/launchCountdown";
...
<p className="countdown-date">{GLOA_LAUNCH_FULL_LABEL}</p>
</div>
{state?.launched
...
<p className="shop-strip-date">{GLOA_LAUNCH_FULL_LABEL}</p>
</div>
</section>
}
...
<p className="eyebrow shop-hero-eyebrow gloa-hero-eyebrow">GLOA · SHOP</p>
...
<i className="shop-hero-line shop-hero-line-accent gloa-hero-secondary">alles was du brauchst.</i>
</h1>
<p className="shop-hero-lead">{lead}</p>
{price}
<p className="shop-hero-meta">LAUNCH AM {GLOA_LAUNCH_FULL_LABEL}</p>
...
// They are decorative - the label beside each one carries the meaning.
const researchBlocks=[{
  label:"Was Matcha enthält",
  body:"Von Natur aus Koffein, L-Theanin und Pflanzenstoffe aus der Catechin-Gruppe wie EGCG. Weil beim Matcha das ganze Blatt getrunken wird, enthält er davon spürbar mehr als klassisch aufgegossener Grüntee.",
  icon:<svg className="matcha-research-icon" viewBox="0 0 24 24" width="22" height="22" aria-hidden="true" focusable="false"><path d="M19.5 4.5c0 7.7-4.2 12.2-10.1 12.2-1.5 0-2.8-.3-3.8-.8.4-5.9 4.4-9.9 10.2-10.7 1.4-.2 2.6-.4 3.7-.7z" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round"/><path d="M5.2 19.5c.6-3.1 2.3-5.9 4.9-7.9" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round"/></svg>,
},{
  label:"In Studien untersucht",
  body:"Die Kombination aus Koffein und L-Theanin wird häufig im Zusammenhang mit Aufmerksamkeit untersucht. Einzelne Übersichtsarbeiten deuten auf kurzfristige Effekte hin, die Ergebnisse sind uneinheitlich und lassen sich nicht pauschal auf ein bestimmtes Produkt übertragen.",
  icon:<svg className="matcha-research-icon" viewBox="0 0 24 24" width="22" height="22" aria-hidden="true" focusable="false"><path d="M12 6.6C10.4 5.4 8.4 4.8 6 4.8H3.2v13H6c2.4 0 4.4.6 6 1.8 1.6-1.2 3.6-1.8 6-1.8h2.8v-13H18c-2.4 0-4.4.6-6 1.8z" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round"/><path d="M12 6.6v13" fill="none" stroke="currentColor" strokeWidth="1.6"/></svg>,
},{
  label:"Was die Forschung noch nicht beantworten kann",
  body:"Für Grüntee-Catechine wurden bislang keine gesundheitsbezogenen Aussagen, etwa zu Stoffwechsel, Herz-Kreislauf oder Zellschutz, als ausreichend belegt eingestuft. Deshalb machen wir dazu keine Versprechen.",
...
<section className="about-real"><div className="about-real-inner home-rail"><div className="about-real-copy"><p className="eyebrow about-real-eyebrow">MATCHA FOR REAL LIFE</p><h2 className="about-real-headline"><span className="about-real-line">Nicht</span><span className="about-real-line">kompliziert.</span><i className="about-real-line about-real-line-accent">Einfach gut.</i></h2></div><div className="about-real-detail"><p className="about-real-body">Morgens, im Büro, im Café oder unterwegs.<br/>Iced, als Latte oder pur.</p><p className="about-real-body">Dein Tag entscheidet, nicht ein Regelwerk.</p></div></div></section>

<section className="about-origin"><div className="about-origin-inner home-rail"><svg className="about-origin-mark" viewBox="0 0 88 44" width="88" height="44" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false"><path d="M2 38 L23 13 L33 24 L45 8 L63 30 L73 20 L86 38"/><path d="M2 38 H86" opacity=".4"/><circle cx="69" cy="9" r="4.4"/></svg><div className="about-origin-copy"><p className="eyebrow about-origin-eyebrow">HERKUNFT</p><p className="about-origin-body">Unser Matcha kommt aus Shizuoka, Japan: 100 % Bio-Matcha, fein vermahlen.</p></div><Link className="about-origin-link" href="/our-matcha">Unser Matcha →</Link></div></section>
...
/* THE INFO STRIP. Four facts - the fifth, a storage claim, was retired
   here in this pass. */
const b2bFacts=["SHIZUOKA, JAPAN","LATTE · ICED · PUR","SCHNELLE NACHBESTELLUNG","500 G · 1 KG GASTRO"];
const b2bAudience:[string,string][]=[
["CAFÉS","M5 7h10v7a4 4 0 0 1-4 4H9a4 4 0 0 1-4-4V7ZM15 9h1.5a2.5 2.5 0 0 1 0 5H15M3.5 21h14"],
["RESTAURANTS","M7 3v5a2 2 0 0 0 4 0V3M9 10v11M17.5 3c-1.4 1.2-2 2.9-2 4.9 0 1.6.7 2.6 2 3V21"],
["HOTELS","M4 21V4h11v17M15 21V9h5v12M2.5 21h19M8 8h1M12 8h1M8 12h1M12 12h1"],
...
<section className="contact-hero"><p className="eyebrow gloa-hero-eyebrow">KONTAKT</p><h1 className="gloa-hero-primary">Schreib<br/><i className="gloa-hero-secondary">uns.</i></h1><p className="contact-sub">Wähl den richtigen Weg und deine Nachricht landet da, wo sie hingehört.</p></section>
...
<p>Rechtsgrundlage ist deine Einwilligung nach Art. 6 Abs. 1 lit. a DSGVO. Wir verwenden ein Double-Opt-In-Verfahren: Nach deiner Eintragung senden wir dir eine E-Mail mit einem Bestätigungslink. Erst wenn du diesen Link anklickst, gilt deine Eintragung als bestätigt. Bestätigst du sie nicht, löschen wir die Eintragung nach 14 Tagen. Zur Dokumentation deiner Einwilligung speichern wir zusätzlich den Zeitpunkt der Eintragung sowie den Einwilligungstext, der dir dabei angezeigt wurde.</p>
<p>Diese E-Mail-Adresse verwenden wir ausschließlich für die Bestätigung deiner Eintragung und für die Benachrichtigung über den Launch. Ein Newsletter ist damit nicht verbunden: Du erhältst über diese Eintragung keine regelmäßigen Marketing-E-Mails, keine Produktwerbung, keine Angebote und keine Event-Einladungen, und wir übertragen die Daten nicht in andere Marketing- oder Verteilerlisten. Möchten wir dir darüber hinaus E-Mails senden, holen wir dafür vorher eine gesonderte Einwilligung ein.</p>
