...
<section className="about-hero"><div className="about-hero-inner home-rail"><div className="about-hero-copy"><p className="eyebrow about-hero-eyebrow">ÜBER GLOA</p><h1 className="about-hero-headline"><span className="about-hero-line">Good energy.</span><i className="about-hero-line about-hero-line-accent">No theatre.</i></h1></div><div className="about-hero-side"><p className="about-hero-lead">GLOA bringt Matcha aus Shizuoka in einen Alltag, der nicht nach Regeln fragt.</p><p className="about-hero-sub">Für Latte, iced, pur oder genau so, wie du ihn magst.</p><p className="about-hero-meta"><span>SHIZUOKA / JAPAN</span><span>BERLIN / GERMANY</span><span>EST. 2026</span></p></div></div></section>
...
<section className="b2b-hero"><div className="b2b-hero-inner home-rail"><div className="b2b-hero-copy"><p className="eyebrow b2b-hero-eyebrow">GLOA FOR BUSINESS</p><h1 className="b2b-hero-headline"><span className="b2b-hero-line">Dein Matcha.</span><i className="b2b-hero-line b2b-hero-line-accent">Dein Signature-Drink.</i></h1><p className="b2b-hero-lead">Matcha aus Shizuoka für moderne Menüs.</p><Link className="cta b2b-hero-cta" href="?intent=sample#lead" onClick={()=>track("sample_request_start")}>Sample anfragen</Link></div><div className="b2b-hero-product"><span className="b2b-hero-pedestal" aria-hidden="true"/><span className="b2b-hero-pack"><img src="/img/B2B Packung.png" alt="GLOA Matcha B2B Packung" fetchPriority="high"/></span></div><ul className="b2b-hero-audience">{b2bAudience.map(([label,d])=><li key={label}><svg viewBox="0 0 24 24" width="17" height="17" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false"><path d={d}/></svg><span>{label}</span></li>)}</ul></div></section>
