...
<section className="about-why"><div className="about-why-left"><div className="about-why-left-inner"><p className="eyebrow about-why-eyebrow">WHY GLOA EXISTS</p><h2 className="about-why-headline"><span className="about-why-line">Matcha gehört</span><span className="about-why-line">nicht in eine</span><i className="about-why-line about-why-line-accent">Schublade.</i></h2></div></div><div className="about-why-right"><div className="about-why-right-inner"><p>Wir mögen Matcha. Nur nicht die Regeln, die manchmal darum gebaut werden.</p><p>GLOA soll unkompliziert funktionieren: im Café, im Büro, unterwegs oder zu Hause.</p><p>Kein Dresscode.<br/>Kein Pflichtprogramm.<br/>Ein gutes Produkt.<br/>Du entscheidest, was du daraus machst.</p></div></div></section>
