...
function Contact(){return <main className="inner"><div className="stack-pair"><PageHero index="05" eyebrow="KONTAKT" title={<>Schreib<br/><i>uns.</i></>} text="Waehl den richtigen Weg und deine Nachricht landet da, wo sie hingehoert." tone="contact"/><section className="contact-choices"><a href="#customer"><span>KUNDE</span><h2>Fragen zu<br/>Produkt & Bestellung.</h2><b>Schreib uns</b></a><a href="/for-cafes"><span>BUSINESS</span><h2>Grosshandel,<br/>Samples & Cafés.</h2><b>Zum B2B-Bereich →</b></a></section></div><form id="customer" className="customer-form" onSubmit={e=>e.preventDefault()}><label>Name<input required/></label><label>E-Mail<input required type="email"/></label><label>Nachricht<textarea required/></label><button className="cta">Nachricht senden</button></form></main>}
