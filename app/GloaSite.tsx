...
<section className="matcha-facts"><p className="eyebrow">THE FACTS</p><h2>Was wir<br/><i>wissen.</i></h2><div className="matcha-facts-grid"><div><span>HERKUNFT</span><strong>Shizuoka, Japan</strong></div><div><span>ERNTE</span><strong>2. und 3. Pflückung</strong></div><div><span>VERWENDUNG</span><strong>Latte · Iced · Pur</strong></div><div><span>MINDESTHALTBARKEIT</span><strong>3 Jahre</strong></div><div><span>LAGERUNG</span><strong>Kühl und trocken</strong></div><div><span>LAGER</span><strong>Deutschland</strong></div></div><div className="matcha-facts-secondary"><p>GASTRO-FORMATE · 500 g · 1 kg</p><p>MAHLUNG · Industriell · ca. 6 Monate vor Kauf</p></div></section>
...
<section className="matcha-howto"><div className="section-head"><div><p className="eyebrow">HOW TO GLOA</p><h2>Drei Wege.<br/><i>Alle easy.</i></h2></div></div><div className="matcha-method-grid"><article><span>01</span><h3>Matcha Latte</h3><ol><li>Matcha dosieren</li><li>Mit wenig Wasser glatt rühren</li><li>Milch oder Pflanzendrink dazu</li><li>Heiß genießen</li></ol></article><article><span>02</span><h3>Iced Matcha</h3><ol><li>Matcha dosieren</li><li>Mit wenig Wasser glatt rühren</li><li>Über Eis geben</li><li>Milch oder Pflanzendrink dazu</li></ol></article><article><span>03</span><h3>Pure Matcha</h3><ol><li>Matcha dosieren</li><li>Mit wenig Wasser glatt rühren</li><li>Mit Wasser auffüllen</li><li>Direkt genießen</li></ol></article></div></section>
