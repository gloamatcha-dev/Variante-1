...
{slug:"classic-matcha-latte",title:"Classic Matcha Latte",category:"REZEPT",time:"5 MIN",servings:"1 Tasse",tags:["LATTE"],image:"/img/gloa-morning.png",alt:"Classic Matcha Latte",excerpt:"Der Klassiker. Cremig, warm und easy.",description:"Der GLOA-Klassiker: warme Milch oder Pflanzendrink, aufgeschäumt und über Matcha gegossen. Cremig und unkompliziert.",ingredients:["1 TL Matcha (ca. 3\u20134 g)","30 ml heißes Wasser (ca. 80 \u00b0C)","200 ml Milch oder Pflanzendrink","Optional: Süße nach Geschmack"],steps:["Matcha in eine Schale oder ein Glas geben.","Mit heißem Wasser übergießen und glatt rühren.","Milch oder Pflanzendrink erwärmen und aufschäumen.","Matcha-Mischung in die Tasse geben, Milch darüber gießen.","Optional süßen und genießen."],featured:true},
{slug:"iced-matcha-latte",title:"Iced Matcha Latte",category:"REZEPT",time:"4 MIN",servings:"1 Glas",tags:["ICED","LATTE"],image:"/img/gloa-iced.png",alt:"Iced Matcha Latte",excerpt:"Kalt, cremig und erfrischend.",description:"Matcha Latte, nur kalt. Für warme Tage und unterwegs.",ingredients:["1 TL Matcha (ca. 3\u20134 g)","30 ml heißes Wasser (ca. 80 \u00b0C)","150\u2013200 ml kalte Milch oder Pflanzendrink","Eiswürfel","Optional: Süße nach Geschmack"],steps:["Matcha mit heißem Wasser glatt rühren.","Ein Glas mit Eiswürfeln füllen.","Kalte Milch oder Pflanzendrink eingießen.","Matcha-Mischung langsam darüber gießen.","Optional süßen und genießen."],featured:true},
...
{slug:"orange-zest-matcha-tonic",title:"Orange Zest Matcha Tonic",category:"REZEPT",time:"4 MIN",servings:"1 Glas",tags:["ICED","SPARKLING","REFRESHING"],image:"/img/gloa-recipe-orange-zest-tonic.png",alt:"Orange Zest Matcha Tonic",excerpt:"Zitrisch, sparkling und super frisch.",description:"Zitrisch, frisch und leicht bitter. Ein klarer Sommerdrink mit Matcha-Tonic-Twist.",ingredients:["30 ml Orange-Zest-Sirup oder 60 ml Orangensaft","60\u2013100 ml Tonic Water","Eiswürfel","1 TL Matcha (ca. 4 g)","60 ml Wasser zum Anrühren","Optional: Orangenzeste"],steps:["Orange-Zest-Sirup oder Orangensaft in ein Glas geben.","Eis hinzufügen.","Mit Tonic Water auffüllen.","Matcha mit Wasser glatt rühren.","Langsam über die Eiswürfel gießen, damit eine schöne Schichtung entsteht.","Optional mit Orangenzeste finishen."],featured:true},
...
<section className="matcha-hero"><div className="matcha-hero-copy"><p className="eyebrow">UNSER MATCHA</p><h1>Matcha.<br/><i>Ohne Umwege.</i></h1><p className="lead">100 % Bio-Matcha aus Shizuoka, Japan. Für Latte, pur oder iced – klar beschrieben, nichts erfunden.</p></div><div className="matcha-hero-visual"><img src="/img/gloa-hero-packaging.png" alt="GLOA Matcha Verpackung"/></div></section>
...
<section className="matcha-what"><div><p className="eyebrow">WAS IST MATCHA</p><h2>Pulver statt<br/><i>Aufguss.</i></h2><p>Matcha ist gemahlener grüner Tee. Anders als bei klassisch aufgegossenem Tee trinkst du bei Matcha das fein vermahlene Blatt direkt mit – nicht nur den Sud. Deshalb enthält Matcha von Natur aus mehr Koffein, L-Theanin und Catechine wie EGCG als ein Aufguss aus derselben Teemenge. Wie viel genau, hängt unter anderem von Anbau, Ernte, Verarbeitung und Zubereitung ab.</p></div><div className="matcha-what-img"><img src="/img/gloa-work.png" alt="Iced Matcha am Arbeitsplatz"/></div></section>
