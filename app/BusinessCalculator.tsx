...
export function BusinessCalculator(){
 ...
 return <><section className="b2b-compare"><p className="eyebrow">BEZUGSMODELLE</p><h2>Flexibel bestellen<br/><i>oder langfristig profitieren.</i></h2><div className="b2b-compare-grid"><div className="b2b-compare-card"><p className="eyebrow">FLEXIBEL</p><h3>Regelmäßige Belieferung</h3><ul><li>5 % Preisvorteil gegenüber Einzelbestellung</li><li>Flexible monatliche Lieferung</li></ul><button className="cta" onClick={()=>choose("wholesale")}>Konditionen anfragen</button></div><div className="b2b-compare-card"><p className="eyebrow">PLANBAR</p><h3>12-Monats-Partnerschaft</h3><ul><li>10 % Preisvorteil gegenüber Einzelbestellung</li><li>Planbare monatliche Belieferung</li></ul><button className="cta cream" onClick={()=>choose("wholesale")}>Partnerschaft anfragen</button></div></div><p className="b2b-compare-note">Je länger wir deinen Bedarf planen können, desto größer ist dein Preisvorteil. Preise und Konditionen erhältst du auf Anfrage.</p></section>

<section className="b2b-portal-hint"><div><p className="eyebrow">B2B KUNDENPORTAL</p><h2>Preise, Konditionen<br/><i>und dein Dashboard.</i></h2><p>Detaillierte Preise, individuelle Konditionen und ein eigenes B2B-Dashboard stehen dir nach Freigabe deines Accounts im GLOA Kundenportal zur Verfügung. Stell jetzt eine Anfrage — wir melden uns mit deinem persönlichen Angebot.</p><button className="cta" onClick={()=>choose("wholesale")}>B2B-Anfrage starten</button></div></section>
...
// Die Komponente bleibt für das spätere B2B-Kundenportal erhalten.
// ──────────────────────────────────────────────────────────────────────
