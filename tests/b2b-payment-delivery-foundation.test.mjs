...
test("57: no migration up to 059 is modified in the working tree", () => {
  ...
  assert.strictEqual(files[files.length - 2], "059_b2b_supply_commerce_foundation.sql");
  assert.strictEqual(files[files.length - 1], MIGRATION);
  assert.strictEqual(files.length, 60);
});
