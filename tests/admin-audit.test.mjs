...
test("6c: 052 is additive, and edits none of the 51 before it", () => {
  ...
  assert.equal(files[files.length - 7], "054_b2c_price_alignment.sql",
    "054 is no longer the migration directly below the newest");
  assert.equal(files[files.length - 9], "052_admin_activity_audit.sql",
...
test("8h: exposing the tab is a UI concern - it touched no migration", () => {
  ...
  assert.equal(files.length, 60, "a migration was added or removed by a navigation fix");
