...
test("55: no migration 038 was created", () => {
  const files = readdirSync(MIGRATIONS).filter(name => /^0*3[89]|^0*[4-9]\d/.test(name));
  assert.deepEqual(files, [], "this phase required no schema change");
