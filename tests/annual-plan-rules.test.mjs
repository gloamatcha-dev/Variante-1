...
test("27: 039 and 040 are untouched, 041 is the highest, and there is no 042", () => {
  ...
  assert.equal(migrations[migrations.length - 18], "042_annual_delivery_rls_parent_user_privilege.sql");
  ...
  assert.deepEqual(migrations.filter(f => Number(f.slice(0, 3)) > 59), [],
